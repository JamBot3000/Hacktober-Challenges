...
if __name__ == "__main__": 
	...
	gui.title("Simple Calculator in Python") 

	gui.geometry("400x300") 

	equation = StringVar() 

	expression_field = Entry(gui, textvariable=equation, width = 30) 
	expression_field.grid(columnspan=5, ipadx=70, padx =9, pady = 9) 
	...
	Exit= Button(gui, text='Exit', fg='black', bg='blue', 
					command=exitSystem, height=1, width=7) 
